...
SimPy is built around Python Generator Functions, which we covered in the previous session.

SimPy also has some tutorials and reference guides on its website : https://simpy.readthedocs.io/en/latest/.
