---
title: Multiple Entity Types Following Different Pathways
jupyter: python3
execute:
  eval: false
format:
...
In this case, we are going to have patients arriving via different routes: Telephone, walk-ins,

- Telephone patients will 'arrive' frequently, only spend a short time with each resource, and have a low probability of needing to see the doctor.
...
- Transferred patients will arrive even less frequently, spend a short amount of time with the nurse, then always visit the doctor and spend a long time with them.
...
So here, a value of '1.0' would mean all patients of that severity saw a doctor.

A value of '0.24' would mean 24% of patients (24 in 100) of that severity saw a doctor.
:::

However, if queues build up in the system, or if our simulation is not long enough for a high proportion of the patients who start their journeys to actually make their whole journey through, we may find that some patients in our list haven't finished their journey before they exit and this may make figures for later parts of the patient journey look a bit strange. Let's rerun this after filtering to only include patients who finished their full journey and exited the system.
...
5. We then ask for the values to be coloured by patient severity.
