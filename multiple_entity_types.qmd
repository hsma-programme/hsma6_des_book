...
As mentioned before, we will be taking the opportunity to better control the randomness of our model runs while we are making this change - so we will import the Exponential function from the [sim_tools](https://tommonks.github.io/sim-tools/00_front_page.html) library.
...
Let's print the output of one of these dictionaries so you can see the effect.
