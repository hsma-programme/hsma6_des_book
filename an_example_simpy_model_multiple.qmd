---
title: An example simpy model - multiple activities
execute:
  eval: true
jupyter: python3
---
...
Of course, in some cases, you might want that - perhaps if you’re modelling a bed as a resource, for example…
:::
