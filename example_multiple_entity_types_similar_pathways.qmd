...
It would be more realistic to implement priority-based queueing, with our ambulance patients jumping to the front of the queue, but this is outside the scope of this chapter. Take a look at the [priority-based queueing](priority_based_queuing.qmd) chapter if you would like to find out more about implementing this.
:::
...
### Click here to view and copy the full code
