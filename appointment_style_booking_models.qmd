...
class Model:
    ...
    def calculate_run_results(self):
        ...
        slots_unused = sum(self.available_slots.to_numpy()[:g.sim_duration , ])[0]

        total_slots_available = sum(
          self.available_slots.to_numpy()[:g.sim_duration , ] +
          self.bookings.to_numpy()[:g.sim_duration , ]
          )[0]


        self.percentage_slots_used = (slots_unused / total_slots_available)
...
#| eval: true
#|
yearly_demand = [3000, 3250, 3500, 3750, 4000]
results_frames = []
